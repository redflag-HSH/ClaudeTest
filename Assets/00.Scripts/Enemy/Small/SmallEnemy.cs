...
public class SmallEnemy : EnemySliceable, IMonsterCore, IDamageable
{
    [Header("Stats")]
    ...
    IMonsterCore.AttackPattern IMonsterCore.PickRandomPattern() =>
        throw new System.NotSupportedException("SmallEnemy uses PickNormalPattern/PickSpecialPattern");

    public IMonsterCore.AttackPattern PickNormalPattern()
    {
